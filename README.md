...
![LocalStack](https://github.com/alperunal92/localstack-dotnet-client//blob/master/assets/localstack-dotnet.png?raw=true)
...
See [sandbox projects](https://github.com/alperunal92/localstack-dotnet-client//tree/master/tests/sandboxes) for more examples.
